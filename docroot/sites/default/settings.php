...
if (file_exists(dirname(__FILE__) . '/config/local.db.inc')) {
  include(dirname(__FILE__) . '/config/local.db.inc');
}
elseif (file_exists(dirname(__FILE__) . '/local.db.inc')) {
  include(dirname(__FILE__) . '/local.db.inc');
}
elseif (!isset($databases) || empty($databases)) {
  $databases['default']['default'] = array(
    'driver'    => 'mysql',
    'database'  => '',
    'username'  => '',
